...
std::optional<bin::Manifold> bin::Physics::DoesOverlap(bin::BoxCollider* a, bin::BoxCollider* b)
{
    ...
    const glm::bvec2 overlap = math::AABB(a->GetWorldPosition(), a->GetSize(), b->GetWorldPosition(), b->GetSize());
